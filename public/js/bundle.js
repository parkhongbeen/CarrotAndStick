...
var changeFace = function changeFace() {
  ...
  if (currentGitNumber < goalGitNumber / 2) {
    ...
    var _typed = new Typed('.carrot-stick', {
    ...
    var _typed2 = new Typed('.carrot-stick', {
    ...
    var _typed3 = new Typed('.carrot-stick', {
...
var saveForcommit = function saveForcommit() {
  var saveGoal = 0;
...
var findMaxId = function findMaxId() {
  return Math.max.apply(Math, [0].concat(_toConsumableArray(todos.map(function (todo) {
    return todo.id;
  })))) + 1;
}; // 이벤트 함수
...
var addTodos = function addTodos() {
  var todo, res;
  return regeneratorRuntime.async(function addTodos$(_context2) {
    while (1) {
...
var removeTodo = function removeTodo(id) {
  var res;
  return regeneratorRuntime.async(function removeTodo$(_context3) {
    while (1) {
...
var changeNav = function changeNav(li) {
  _toConsumableArray($nav.children).forEach(function ($list) {
